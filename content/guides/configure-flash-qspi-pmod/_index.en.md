...
- Copy the [QSPI activation script](#1-qspi-activation-script) provided at the end of this guide.
...
{{% figure src="images/commander-successful-qspi-enable.png" title="Successfully executing the activation script and enabling QSPI mode"%}}
