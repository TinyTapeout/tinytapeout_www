---
title: USA Workshops - 250 People Tape Out
description: Workshops across the USA - Hackaday Supercon, UCSD, and Stanford
...
cover:
    ...
    alt: Hackaday Supercon Pasadena LA
---
...
Thanks to [UCSD](https://ucsd.edu/), [Efabless](https://chipfoundry.io/efabless), [Precision Innovation](https://precisioninno.com/), and the [IEEE](https://www.ieee.org/) for sponsoring these events and making them accessible to students of all ages.

There's been a lot of interest to run more [workshops](https://tinytapeout.com/workshops/). We're even planning for online versions, so stay tuned!