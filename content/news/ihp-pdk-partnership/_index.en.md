---
title: First experimental tapeout on IHP SG13G2 process
description: 2 test chips planned, first public shuttle mid-2025
...
layout: single
cover:
    image: images/ihppdk.jpeg
    alt: GDS for our first test chip
---
...
IHP's 130nm BiCMOS process adds bipolar junction transistors to traditional CMOS designs, making it ideal for mixed-signal designs combining digital logic with analog elements.

Thanks to [SwissChips](https://swisschips.ethz.ch/) and [ETH Zürich](https://ethz.ch/en.html) for supporting this effort!