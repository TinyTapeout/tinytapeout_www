---
title: TT01 repos updated and datasheet in progress
description: 140 pull requests opened to get TT01 repos in shape; first draft datasheet created
...
cover:
    ...
    alt: New interactive 3D viewer
---

Big update! We've submitted all 150+ designs to MPW7, the 7th free Google open source shuttle. We're now getting the repos in order!
...
There's also a new interactive 3D viewer, contributed by Maximo Balestrini and Proppy, available on the GitHub action page.

A huge thanks to Tnt, Jannis, Maximo, Omer, Proppy and Uri for all their help making this happen. More updates as soon as we hear back on the lottery.